...
public class CntrlReportesCompras extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		paramEstado = "A";
		datoBasico = servicioDatoBasico.buscarPorNombre("ADQUISICION");
	...
	public void imprimirArchivoTexto() throws IOException{
		...
		String arch = Sessions.getCurrent().getWebApp().getRealPath("/WEB-INF/"+sFichero);
        ...
        try{
            ...
            bw.write("Reportes de Compras"+"\n");
            bw.write("Desde: "+dtInicio.getText()+" Hasta: "+dtFin.getText()+"\n");
            int ind = lbxReporte.getItemCount();
       		for (int i = 0; i < ind; i++) {
         			bw.write(lbxReporte.getItemAtIndex(i).toString()+"\n");
       		}
            ...
            amedia = new AMedia(arch,null,null, fichero,false);
